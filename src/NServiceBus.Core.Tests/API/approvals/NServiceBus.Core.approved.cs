...
namespace NServiceBus
{
    ...
    public class TransportMessage
    {
        ...
        [System.ObsoleteAttribute("Not used anymore, you most likely should use a `OutgoingMessageInstead`. Will be " +
...
namespace NServiceBus.Pipeline.Contexts
{
    public abstract class HandlingStageBehavior : NServiceBus.Pipeline.Behavior<NServiceBus.Pipeline.Contexts.HandlingStageBehavior.Context>
    {
        ...
        public class Context : NServiceBus.Pipeline.Contexts.IncomingContext
        {
    ...
    {
        public OutgoingContext(NServiceBus.Pipeline.BehaviorContext parentContext, NServiceBus.Unicast.DeliveryOptions deliveryOptions, NServiceBus.Unicast.Messages.LogicalMessage message, System.Collections.Generic.Dictionary<string, string> headers, string messageId) { }
    ...
    public abstract class PhysicalOutgoingContextStageBehavior : NServiceBus.Pipeline.Behavior<NServiceBus.Pipeline.Contexts.PhysicalOutgoingContextStageBehavior.Context>
    {
        ...
        public class Context : NServiceBus.Pipeline.BehaviorContext
        {
            public Context(byte[] body, NServiceBus.Pipeline.Contexts.OutgoingContext parentContext) { }
            public byte[] Body { get; set; }
            public NServiceBus.Unicast.DeliveryOptions DeliveryOptions { get; }
            public System.Collections.Generic.Dictionary<string, string> Headers { get; }
            public string MessageId { get; }
...
namespace NServiceBus.Transports
{
    ...
    {
        void Audit(NServiceBus.Unicast.SendOptions sendOptions, NServiceBus.Transports.OutgoingMessage message);
    }
